...
````
set(PICO_SDK_PATH "/home/your_name/pico2/pico-sdk")
#"your_name"need to change to your user name!
````
然后编译项目
````
cd src
...
````
## 参考资料
1.B站“爱跑步的小何”三阶魔方机器人工程 https://gitee.com/hemn1990/rubiks-cube-robot<br>
